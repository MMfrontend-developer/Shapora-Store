      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <div
              key={step.id}
              className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center text-center  transition-all duration-500 ease-in-out hover:scale-105 active:scale-105 hover:shadow-2xl active:shadow-2xl"
            >
